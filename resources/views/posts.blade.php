...
@section('container')
    ...
    @if ($posts->count())
        <div class="card mb-3">
            @if ($posts[0]->image)
                <div class="card-img-top" style="max-height: 400px; max-width:1200px; overflow: hidden;">
            ...
            <div class="card-body text-center">
                <h3 class="card-title"><a href="/post/{{ $posts[0]->slug }}">{{ $posts[0]->title }}</a></h3>
                <p>
                ...
                <a href="/post/{{ $posts[0]->slug }}" class="btn btn-outline-info">Read more</a>
            </div>
        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/post/{{ $post->slug }}" class="btn btn-outline-info">Read more</a>
                            </div>
                        </div>
                    </div>
                @endforeach
